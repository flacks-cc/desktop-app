...
public class ReservacionView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Administrar reservaciones", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        tblReservacion.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Fecha", "Hora", "Nota", "Cliente", "Servicio"
            }
        ) {
        ...
        jScrollPane3.setViewportView(tblReservacion);
        if (tblReservacion.getColumnModel().getColumnCount() > 0) {
            tblReservacion.getColumnModel().getColumn(0).setResizable(false);
            tblReservacion.getColumnModel().getColumn(1).setResizable(false);
            tblReservacion.getColumnModel().getColumn(2).setResizable(false);
            tblReservacion.getColumnModel().getColumn(3).setResizable(false);
            tblReservacion.getColumnModel().getColumn(4).setResizable(false);
            tblReservacion.getColumnModel().getColumn(5).setResizable(false);
        }
        ...
        jLabel6.setText("<html>Correo del cliente");
